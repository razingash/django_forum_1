# Generated by Django 4.2.10 on 2024-03-01 21:53
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                     related_name='replies', to='forum.comments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(
                    choices=[('everyone', 'everyone'), ('adults', 'adults'), ('illuminated', 'illuminated'),
                             ('illuminated adults', 'illuminated adults')], default='adults', max_length=30)),
                ('aviability_lvl', models.PositiveSmallIntegerField(default=1)),
                ('rating', models.SmallIntegerField(blank=True, default=0, null=True)),
                ('status',
                 models.CharField(choices=[('opened', 'открыта'), ('closed', 'закрыта'), ('banned', 'забанена')],
                                  default='opened', max_length=30, null=True)),
